      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-slate-900 mb-2">Clientes</h3>
            <p className="text-slate-600 text-sm">Gestionar directorio de clientes</p>
          </Link>
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-slate-900 mb-2">Vehículos</h3>
            <p className="text-slate-600 text-sm">Catálogo de vehículos disponibles</p>
          </Link>
